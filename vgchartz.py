...
columns = {'Rank': rank, 'Name': gname, 'Platform': platform, 'Publisher': publisher, 'Developer': developer, 'Critic_Score': critic_score,
           'Global_Sales': sales_gl, 'NA_Sales': sales_na, 'EU_Sales': sales_eu, 'JP_Sales': sales_jp, 'Other_Sales': sales_ot}
...
print(df)
df = df[['Rank', 'Name', 'Platform', 'Publisher','Developer', 'Critic_Score',
         'Global_Sales', 'NA_Sales', 'EU_Sales', 'JP_Sales', 'Other_Sales',
         ]]
df.index.name = None
df.to_csv("vgsales2021.csv", sep=",", encoding='utf-8')